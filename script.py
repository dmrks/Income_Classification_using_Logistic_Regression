...
#7. Evaluate the predictions of the model on the test set. Print the confusion matrix = [[4775  251] [ 879  608]] and accuracy score = 0.8265008444649163
...
plt.title('barplot of the coefficients')
plt.show()
plt.close()
